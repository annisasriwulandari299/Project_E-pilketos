...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/login/images/fav.png')}}" type="image/x-icon">
   <link href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@400;500&display=swap" rel="stylesheet">
    <link rel="shortcut icon" href="{{asset('assets/login/images/fav.jpg')}}">
                    ...
                    <div class="col-lg-5 col-md-6 no-padding">
                        <div class="login-box">
                            ...
                            <div class="login-row row no-margin">
                                <label for=""><i class="fas fa-envelope"></i> NIS</label>
                     ...
                     <div class="col-lg-7 col-md-6 img-box">
                        <img src="{{asset('assets/login/images/sideimg.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
