...
<head>
    ...
    <title>Detail Data Pemilih</title>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    value="{{$pemilih->nis}}" disabled/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="kelas">Kelas</label>
                                                    <input type="text" class="form-control" name="kelas" 
                                                    value="{{$pemilih->kelas}}" disabled/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="jurusan">Jurusan</label>
                                                    <input type="text" class="form-control" name="jurusan" 
                                                    value="{{$pemilih->jurusan}}" disabled/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="password">Password</label>
                                                    <input type="password" class="form-control" name="password" 
                                                    value="{{$pemilih->password}}" disabled/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="status" class="form-label">Status</label>
                                                    <input type="text" class="form-control" name="status" value="{{ $pemilih -> status }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                </div>
